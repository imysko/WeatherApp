...
public val Icons.Snowing: ImageVector
    get() {
        if (_snowing != null) {
            return _snowing!!
        }
        _snowing = Builder(name = "Snowing", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveQuadTo(205.0f, 725.0f)
                quadToRelative(0.0f, -14.0f, 10.5f, -24.5f)
                reflectiveQuadTo(240.0f, 690.0f)
                quadToRelative(14.0f, 0.0f, 24.5f, 10.5f)
                reflectiveQuadTo(275.0f, 725.0f)
                quadToRelative(0.0f, 14.0f, -10.5f, 24.5f)
                reflectiveQuadTo(240.0f, 760.0f)
                close()
                moveTo(720.0f, 760.0f)
                quadToRelative(-14.0f, 0.0f, -24.5f, -10.5f)
                reflectiveQuadTo(685.0f, 725.0f)
                quadToRelative(0.0f, -14.0f, 10.5f, -24.5f)
                reflectiveQuadTo(720.0f, 690.0f)
                quadToRelative(14.0f, 0.0f, 24.5f, 10.5f)
                reflectiveQuadTo(755.0f, 725.0f)
                quadToRelative(0.0f, 14.0f, -10.5f, 24.5f)
                reflectiveQuadTo(720.0f, 760.0f)
                close()
                moveTo(360.0f, 920.0f)
                quadToRelative(-14.0f, 0.0f, -24.5f, -10.5f)
                reflectiveQuadTo(325.0f, 885.0f)
                quadToRelative(0.0f, -14.0f, 10.5f, -24.5f)
                reflectiveQuadTo(360.0f, 850.0f)
                quadToRelative(14.0f, 0.0f, 24.5f, 10.5f)
                reflectiveQuadTo(395.0f, 885.0f)
                quadToRelative(0.0f, 14.0f, -10.5f, 24.5f)
                reflectiveQuadTo(360.0f, 920.0f)
                close()
                moveTo(480.0f, 760.0f)
                quadToRelative(-14.0f, 0.0f, -24.5f, -10.5f)
                reflectiveQuadTo(445.0f, 725.0f)
                quadToRelative(0.0f, -14.0f, 10.5f, -24.5f)
                reflectiveQuadTo(480.0f, 690.0f)
                quadToRelative(14.0f, 0.0f, 24.5f, 10.5f)
                reflectiveQuadTo(515.0f, 725.0f)
                quadToRelative(0.0f, 14.0f, -10.5f, 24.5f)
                reflectiveQuadTo(480.0f, 760.0f)
                close()
                moveTo(600.0f, 920.0f)
                quadToRelative(-14.0f, 0.0f, -24.5f, -10.5f)
                reflectiveQuadTo(565.0f, 885.0f)
                quadToRelative(0.0f, -14.0f, 10.5f, -24.5f)
                reflectiveQuadTo(600.0f, 850.0f)
                quadToRelative(14.0f, 0.0f, 24.5f, 10.5f)
                reflectiveQuadTo(635.0f, 885.0f)
                quadToRelative(0.0f, 14.0f, -10.5f, 24.5f)
